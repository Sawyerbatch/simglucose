# -*- coding: utf-8 -*-
"""
Created on Thu Nov  3 13:34:31 2022
...
class RandomController(Controller):
    ...
    def __init__(self, target=140):
        self.quest = pd.read_csv(CONTROL_QUEST) # calcolare valore basale
        self.patient_params = pd.read_csv(PATIENT_PARA_FILE) # calcolare valore basale
        self.target = target # eliminare

    def policy(self, observation, reward, done, **kwargs):
        sample_time = kwargs.get('sample_time', 1) # ogni quanto fa l'azione
    ...
    def _rnd_policy(self, name, meal, glucose, env_sample_time): # meal andrà tolto
        """
        ...
        if meal > 0:
            ...
            # SOSTITUIRE CON BOLO RANDOM PRESO DALLO SPAZIO DELLE AZIONI
        else:
            bolus = 0  # unit: U
