...
for strategy in ['ipo', 'iper']:

    for training_n_steps in training_n_step_list:
    
        # writer = pd.ExcelWriter(os.path.join(strategy_path,'performance_ablation_study_ppo_test_timesteps_'+str(test_timesteps)+'_training_nsteps_'+str(training_n_steps)+'_training_tmstp_'+str(training_total_timesteps)+'_ripetizioni_'+str(ripetizioni)+'_'+strategy+'.xlsx'))
        
        writer = pd.ExcelWriter('performance_ablation_study_ppo_test_timesteps_'+str(test_timesteps)+'_training_nsteps_'+str(training_n_steps)+'_training_tmstp_'+str(training_total_timesteps)+'_ripetizioni_'+str(ripetizioni)+'_'+strategy+'.xlsx')
        ...
        for k,v in opt_dict.items():
            ...
            for i, scen in zip(range(ripetizioni), scenarios.values()):
                ...
                # if strategy == 'ipo':
                #     model_ppo_iper = PPO.load(os.path.join(model_path, 'ppo_sim_mod_food_hour_'+paziente+'_tmstp'+str(training_total_timesteps)+'_lr00003_insmax'+ipo+'_customscen'))  # ipo 
                #     model_ppo_ipo = PPO.load(os.path.join(model_path, 'ppo_sim_mod_food_hour_'+paziente+'_tmstp'+str(training_total_timesteps)+'_lr00003_insmax'+ipo+'_customscen'))  # ipo
                # elif strategy == 'iper':
                #     model_ppo_iper = PPO.load(os.path.join(model_path, 'ppo_sim_mod_food_hour_'+paziente+'_tmstp'+str(training_total_timesteps)+'_lr00003_insmax'+iper+'_customscen')) # iper
                #     model_ppo_ipo = PPO.load(os.path.join(model_path, 'ppo_sim_mod_food_hour_'+paziente+'_tmstp'+str(training_total_timesteps)+'_lr00003_insmax'+iper+'_customscen')) # iper
                    
                # if strategy == 'ipo':    
                #     model_ppo_iper = PPO.load(os.path.join(model_path, 'ppo_withcaps_'+paziente+'_nsteps_'+str(training_n_steps)+'_total_tmstp_'+str(training_total_timesteps)+'_lr_00003_insmax'+ipo)) # ipo
                ...
                #     model_ppo_ipo = PPO.load(os.path.join(model_path, 'ppo_withcaps_'+paziente+'_nsteps_'+str(training_n_steps)+'_total_tmstp_'+str(training_total_timesteps)+'_lr_00003_insmax'+iper))  # iper
                
                if strategy == 'ipo':    
                    model_ppo_iper = PPO.load('ppo_withcaps_'+paziente+'_nsteps_'+str(training_n_steps)+'_total_tmstp_'+str(training_total_timesteps)+'_lr_00003_insmax'+ipo) # ipo
                    model_ppo_ipo = PPO.load('ppo_withcaps_'+paziente+'_nsteps_'+str(training_n_steps)+'_total_tmstp_'+str(training_total_timesteps)+'_lr_00003_insmax'+ipo)  # ipo 
                elif strategy == 'iper': 
                    model_ppo_iper = PPO.load('ppo_withcaps_'+paziente+'_nsteps_'+str(training_n_steps)+'_total_tmstp_'+str(training_total_timesteps)+'_lr_00003_insmax'+iper) # iper
                    model_ppo_ipo = PPO.load('ppo_withcaps_'+paziente+'_nsteps_'+str(training_n_steps)+'_total_tmstp_'+str(training_total_timesteps)+'_lr_00003_insmax'+iper)  # iper
