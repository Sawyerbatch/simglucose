...
training_n_step_list = [2048]
training_total_timesteps = [16384]
...
opt_dict = {
            'adult#001':('006',90, 'adult#008'),
            'adult#002':('006',90, 'adult#008'),
            'adult#003':('007',90, 'adult#007'),
            'adult#004':('007',90, 'adult#010'),
            'adult#005':('009',90, 'adult#001'),
            'adult#006':('007',90, 'adult#003'),
            'adult#007':('007',90, 'adult#003'),
            'adult#008':('009',90, 'adult#001'),
...
opt_dict = {
            # 'adult#001':('006',90, 'adult#008'),
            # 'adult#002':('006',90, 'adult#008'),
            'adult#003':('006',90, 'adult#008'),
            # 'adult#004':('007',90, 'adult#010'),
            # 'adult#005':('009',90, 'adult#001'),
            'adult#006':('006',90, 'adult#008'),
            'adult#007':('006',90, 'adult#008'),
            # 'adult#008':('009',90, 'adult#001'),
            'adult#009':('006',90, 'adult#008'),
            # 'adult#010':('007',90, 'adult#004')
            }
...
for training_n_steps, training_total_timesteps in zip(training_n_step_list, training_total_timesteps) :
    ...
    for k,v in opt_dict.items():
        ...
        for i, scen in zip(range(ripetizioni), scenarios.values()):
            ...
            model_ppo = PPO.load(os.path.join(model_path, 'ppo_online_callback_'+train+'_nsteps_2048_total_tmstp_16384_lr_00003_insmax'+cap+'__16384_steps'))
