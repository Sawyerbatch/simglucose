...
for paziente in p_list:
    

        
    writer = pd.ExcelWriter(os.path.join(strategy_path,'performance_BBC_con_errore_real_patient_'+paziente+'_timesteps_'+str(test_timesteps)+'_ripetizioni_'+str(ripetizioni)+'.xlsx'))
