...
for reward_type in ['new', 'magni']:
    ...
    #     opt_dict = {
    #         patient_type+'#001': [0.05],
    #         patient_type+'#002': [0.06],
    #         patient_type+'#003': [0.05],
    #         patient_type+'#004': [0.06],
    #         patient_type+'#005': [0.05],
    #         patient_type+'#006': [0.05],
    #         patient_type+'#007': [0.05],
    #         patient_type+'#008': [0.07],
    #         patient_type+'#009': [0.05],
    #         patient_type+'#010': [0.06]
    #     }
