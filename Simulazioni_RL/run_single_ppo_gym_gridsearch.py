...
cap_list = ['005','006','007','008','009', '01']
soglia_list = [90]
ripetizioni = 10
...
for paziente in pazienti_list:
    ...
    for cap in cap_list:
        ...
        for i in range(ripetizioni):
            ...
            model_ppo = PPO.load(os.path.join(model_path, "magni_ppo_withcaps_"+paziente+'_nsteps_'+str(training)+'_total_tmstp_'+str(training)+'_lr_00003_insmax'+cap)) # iper  
        ...
        df_final.to_excel(os.path.join(results_path,'magni_single_ppo_performance_gridsearch_'+paziente+'_'+str(timesteps)+'_train1440(2048)_'+str(ripetizioni)+'ripetizioni.xlsx')
