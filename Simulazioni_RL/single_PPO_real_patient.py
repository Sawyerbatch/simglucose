...
for training_n_steps, training_total_timesteps in zip(training_n_step_list, training_total_timesteps) :
    ...
    for k,v in opt_dict.items():
        ...
        writer = pd.ExcelWriter(os.path.join(strategy_path,'performance_single_ppo_withcaps_safecontrol_real_patient_train_'+train+'_test_'+paziente+'_timesteps_'+str(test_timesteps)+'_training_nsteps_'+str(training_n_steps)+'_training_tmstp_'+str(training_total_timesteps)+'_ripetizioni_'+str(ripetizioni)+'.xlsx'))
