...
# per provare
# iper_control_list = ['018','019','02']
# ipo_control_list = ['005']
# iper_soglia_list = [150,155,160]
# ipo_soglia_list = [85,90,95]
# ripetizioni = 10

# iper_control_list = ['014']
# ipo_control_list = ['005']
...
df_cap_mean.to_excel(os.path.join(strategy_path,'performance_tutti_'+str(timesteps)+'_train1440(2048)_'+str(ripetizioni)+'ripetizioni.xlsx')
